...
const Footer = () => {
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div
        className="flex flex-col items-center gap-4 rounded-lg bg-sky-950 p-6 shadow-lg sm:flex-row sm:justify-between"
      >
      ...
      <div className="mt-16">
        ...
        <div className="mt-16 sm:flex sm:items-center sm:justify-between items-center">
         
          <p className="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-right">
            Copyright &copy; 2024. All rights reserved- please send your e-mail address at danyalhafeez46@gmail.com.
          </p>
        </div>
      </div>
    </div>
